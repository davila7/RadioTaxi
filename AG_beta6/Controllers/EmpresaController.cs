...
namespace AG_beta6.Controllers
{
    public class EmpresaController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id_empr,Rut,Dig,Nombre,Telefono,Descuento,FormaDePago,IdDireccion")] Empresa empresa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id_empr,Rut,Dig,Nombre,Telefono,Descuento,FormaDePago,IdDireccion")] Empresa empresa)
        {
            if (ModelState.IsValid)
            {
